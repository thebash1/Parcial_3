...
public class FormularioEliminar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        LabelLugar.setText("FORMULARIO PARA ELIMINAR");
        ...
        MainPanel.add(BotonRegresar, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 360, 150, 40));

        idLabel.setBackground(new java.awt.Color(255, 255, 255));
        idLabel.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        idLabel.setForeground(new java.awt.Color(0, 0, 0));
        idLabel.setText("id:");
        MainPanel.add(idLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 130, -1, 30));
        ...
        MainPanel.add(idTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 130, 100, 30));
    ...
    private void BotonRegresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonRegresarActionPerformed
        ...
        GestionEquipos regresar_gestion = new GestionEquipos();
        regresar_gestion.setVisible(true);
        dispose();
